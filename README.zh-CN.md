...
**Yi Qian（钱磊）· AI Product Manager（AI 产品经理）**

这个工程示例改编自 AgentLens 审查工作台的生命周期规则（公司名称因合同条款匿名，团队规模 1–10 人）。内部工作台共有 62 条确定性测试，本示例抽取其中 14 条；它保留精简合同并补充输入检查，只覆盖完整应用中的审查规则。
...
由 **Yi Qian（钱磊）** 设计与维护。采用 [MIT 许可](LICENSE)，未捆绑第三方源码。
